...
function ManageAlbums() {
  ...
  const uniqueGenres = [...new Set(albums.map((album) => album.genre))].filter(
    Boolean
  );
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Create, edit, and manage music albums
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center">
              <div className="p-3 bg-blue-100 dark:bg-blue-900/30 rounded-xl">
                <FiDisc className="w-6 h-6 text-blue-600 dark:text-blue-400" />
              </div>
              <div className="ml-4">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm">
            <div className="flex items-center">
              <div className="p-3 bg-green-100 dark:bg-green-900/30 rounded-xl">
                <FiInfo className="w-6 h-6 text-green-600 dark:text-green-400" />
              </div>
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                  Unique Genres
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm overflow-hidden">
          {filteredAlbums.length === 0 ? (
            <div className="text-center py-12">
              <FiDisc className="w-12 h-12 text-gray-400 mx-auto mb-4" />
...
ManageAlbums.Layout = Layout;
export default withAdminAuth(ManageAlbums);
